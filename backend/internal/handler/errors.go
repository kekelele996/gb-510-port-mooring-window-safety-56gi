...
func handleError(c *gin.Context, err error) {
	...
	case errors.Is(err, service.ErrInvalidTransition), errors.Is(err, service.ErrInvalidInput),
		...
		errors.Is(err, service.ErrWindowVersion), errors.Is(err, service.ErrWindowLinked),
		errors.Is(err, service.ErrWindowState), errors.Is(err, service.ErrWindowExpired):
